...
fstZim_mean.to_csv("Zim.vs.COS_avgfst_Autosomes_genes_ranked.csv", index=False)
fstZS_mean.to_csv("ZS.vs.COS_avgfst_Autosomes_genes_ranked.csv", index=False)
fstZH_mean.to_csv("ZH.vs.COS_avgfst_Autosomes_genes_ranked.csv", index=False)
fstZC_mean.to_csv("ZC.vs.COS_avgfst_Autosomes_genes_ranked.csv", index=False)
fstZR_mean.to_csv("ZR.vs.COS_avgfst_Autosomes_genes_ranked.csv", index=False)
"""

fstZim_max.to_csv("Zim.vs.COS_maxfst_genes_ranked.csv", index=False)
fstZS_max.to_csv("ZS.vs.COS_maxfst_genes_ranked.csv", index=False)
fstZH_max.to_csv("ZH.vs.COS_maxfst_genes_ranked.csv", index=False)
fstZC_max.to_csv("ZC.vs.COS_maxfst_genes_ranked.csv", index=False)
fstZR_max.to_csv("ZR.vs.COS_maxfst_genes_ranked.csv", index=False)
"""