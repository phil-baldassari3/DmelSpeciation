...
def find_idx(fst_ls, threshold):
    """
    Function takes in a list of Fst values and returns a list of the indices of the values if they were greater than the given threshold.
...
main("windowed_mean_5kbp_FST_averages_ChromX.csv")
main("windowed_mean_5kbp_FST_averages_Chrom2L.csv")
main("windowed_mean_5kbp_FST_averages_Chrom2R.csv")
main("windowed_mean_5kbp_FST_averages_Chrom3L.csv")
main("windowed_mean_5kbp_FST_averages_Chrom3R.csv")

main("windowed_max_5kbp_FST_averages_ChromX.csv")
main("windowed_max_5kbp_FST_averages_Chrom2L.csv")
main("windowed_max_5kbp_FST_averages_Chrom2R.csv")
main("windowed_max_5kbp_FST_averages_Chrom3L.csv")
main("windowed_max_5kbp_FST_averages_Chrom3R.csv")
