...
###########################
# Read in the file
with open('zim-cos_Chr2L_0.05.vcf', 'r') as _2Lfile:
...
# Write the file out again
with open('dipzim-cos_Chr2L_0.05.vcf', 'w') as _2Lfile1:
...
# Read in the file
with open('dipzim-cos_Chr2L_0.05.vcf', 'r') as _2Lfile1:
  _2Lfiledata1 = _2Lfile1.read()
# Replace the target string
_2Lfiledata1 = _2Lfiledata1.replace('/0/', '/')
_2Lfiledata1 = _2Lfiledata1.replace('/1/', '/')
# Write the file out again
with open('dipzim-cos_Chr2L_0.05.vcf', 'w') as _2Lfile2:
...
###########################
# Read in the file
with open('zim-cos_Chr2R_0.05.vcf', 'r') as _2Rfile:
...
# Write the file out again
with open('dipzim-cos_Chr2R_0.05.vcf', 'w') as _2Rfile1:
...
# Read in the file
with open('dipzim-cos_Chr2R_0.05.vcf', 'r') as _2Rfile1:
  _2Rfiledata1 = _2Rfile1.read()
# Replace the target string
_2Rfiledata1 = _2Rfiledata1.replace('/0/', '/')
_2Rfiledata1 = _2Rfiledata1.replace('/1/', '/')
# Write the file out again
with open('dipzim-cos_Chr2R_0.05.vcf', 'w') as _2Rfile2:
...
###########################
# Read in the file
with open('zim-cos_Chr3L_0.05.vcf', 'r') as _3Lfile:
...
# Write the file out again
with open('dipzim-cos_Chr3L_0.05.vcf', 'w') as _3Lfile1:
...
# Read in the file
with open('dipzim-cos_Chr3L_0.05.vcf', 'r') as _3Lfile1:
  _3Lfiledata1 = _3Lfile1.read()
# Replace the target string
_3Lfiledata1 = _3Lfiledata1.replace('/0/', '/')
_3Lfiledata1 = _3Lfiledata1.replace('/1/', '/')
# Write the file out again
with open('dipzim-cos_Chr3L_0.05.vcf', 'w') as _3Lfile2:
...
###########################
# Read in the file
with open('zim-cos_Chr3R_0.05.vcf', 'r') as _3Rfile:
...
# Write the file out again
with open('dipzim-cos_Chr3R_0.05.vcf', 'w') as _3Rfile1:
...
# Read in the file
with open('dipzim-cos_Chr3R_0.05.vcf', 'r') as _3Rfile1:
  _3Rfiledata1 = _3Rfile1.read()
# Replace the target string
_3Rfiledata1 = _3Rfiledata1.replace('/0/', '/')
_3Rfiledata1 = _3Rfiledata1.replace('/1/', '/')
# Write the file out again
with open('dipzim-cos_Chr3R_0.05.vcf', 'w') as _3Rfile2:
